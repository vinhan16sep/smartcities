        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <a type="button" href="http://dangky.smartcitiesvietnam.com/admin/company/export_company_detail/<?php echo $company['company_id'] ?>" class="btn btn-success" style="margin-bottom: 20px">EXPORT DATA DOANH NGHIỆP</a>
                    </div>
                    <!-- /.tab-content -->
                </div>
            ...
            jQuery.ajax({
                ...
                success: function(result){
                    if(JSON.parse(result).isExitsts == true){
                        ...
                        window.location.href = "http://dangky.smartcitiesvietnam.com/admin/company";
