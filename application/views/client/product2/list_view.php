                ...
                <div class="nav-tabs-custom box-body box-profile" style="box-shadow: 2px 2px 1px grey;">
                    <div class="tab-content">
                        <div class="post">
                            ...
                            <?php endif ?>
                            <h4 style="text-align: center;"><?php echo empty($products) ? 'THÔNG TIN SẢN PHẨM <i class="fa fa-arrow-right" aria-hidden="true"></i> THÔNG TIN DỰ ÁN BẤT ĐỘNG SẢN ỨNG CỬ' : 'Danh sách dự án bất động sản ứng cử' ?></h4>
                                    ...
                                    <div class="col-lg-12" style="margin-top: 10px;">
                                        ...
                                        ?>
                                                    ...
                                                    <?php if($reg_status['is_final'] == 0 && $product['year'] == $eventYear): ?>
                                                        ...
                                                        <td style="text-align: center;width:110px;"><a style="width:132px;" href="<?php echo base_url('client/'.$ctrl_name.'/remove_product/' . $product['id']) ?>" class="btn btn-danger" onclick="return confirm('Chắc chắn xóa sản phẩm?')">Xóa dự án</a></td>
                                                    <?php else: ?>
                                                        ...
                                                        <td style="text-align: center;width:110px;"><a style="width:132px;" href="javascript:void(0);" disabled="disabled" class="btn btn-danger">Xóa dự án</a></td>
                                                    <?php endif; ?>
                                        <?php
                                                    echo '</tr>';
                                                endif;
                            ...
                            <?php if($reg_status['is_final'] == 0): ?>
                                <div>
                                    <a style="display: inline;margin-right:10px !important;"  href="<?php echo base_url('client/'.$ctrl_name.'/create_product') ?>" class="btn btn-primary pull-left"><b>Thêm dự án</b></a>
