                ...
                <div class="nav-tabs-custom box-body box-profile" style="box-shadow: 2px 2px 1px grey;">
                    <div class="tab-content">
                        <div class="post">
                            ...
                            <?php endif ?>
                            <h4 style="text-align: center;"><?php echo empty($products) ? 'Thông tin lĩnh vực ứng cử' : 'Danh sách các thành phố thông minh' ?></h4>
                                        ...
                                        if (!empty($products)) {
                                            foreach ($products as $key => $product):
                                                if($product['year'] == $year['year']):
                                                    echo '<tr>';
                                                    echo '<td>' . ($key + 1) . '</td>';
                                                    echo '<td><a href="' . base_url('client/'.$ctrl_name.'/detail_product/' . $product['id']) . '">' . $type_smart_city[$product['field_21']] . '</a></td>';
                                        ?>
                                                    ...
                                                    <?php if($reg_status['is_final'] == 0 && $product['year'] == $eventYear): ?>
                                                        ...
                                                        <td style="text-align: center;width:110px;"><a style="width:132px;" href="<?php echo base_url('client/'.$ctrl_name.'/remove_product/' . $product['id']) ?>" class="btn btn-danger" onclick="return confirm('Chắc chắn xóa sản phẩm?')">Xóa hạng mục</a></td>
                                                    <?php else: ?>
                                                        ...
                                                        <td style="text-align: center;width:110px;"><a style="width:132px;" href="javascript:void(0);" disabled="disabled" class="btn btn-danger">Xóa hạng mục</a></td>
                                                    <?php endif; ?>
                                        <?php
                                                    echo '</tr>';
                                                endif;
                            ...
                            <?php if($reg_status['is_final'] == 0): ?>
                                <div>
                                    <a style="display: inline;margin-right:10px !important;"  href="<?php echo base_url('client/'.$ctrl_name.'/create_product') ?>" class="btn btn-primary pull-left"><b>Thêm hạng mục</b></a>
