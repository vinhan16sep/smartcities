    ...
    <section class="content">
        <div class="row modified-mode">
            <div class="col-lg-10 col-lg-offset-0">
                ...
                <?php
                echo form_open_multipart(base_url('client/company/edit?year=' . $eventYear), array('class' => 'form-horizontal', 'id' => 'company-form'));
                ?>
                <div class="form-group">
                    <div class="row">
...
//                                echo form_textarea('description', set_value('description', html_entity_decode($company['description'])), 'class="form-control tinymce-area"');
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('linhvuckd', $company['linhvuckd'], 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('themanh', $company['themanh'], 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group col-sm-12 text-right submit-extra-form">
                    ...
                    <div class="col-sm-9 col-md-9 col-sx-12">
                        <div>
                            <a style="display: inline;" href="<?php echo base_url('client/company/index'); ?>" class="btn btn-default pull-left"><b>Quay lại</b></a>
                            <?php
