    ...
    <section class="content">
        ...
        <div class="row modified-mode">
            <div class="col-lg-10 col-lg-offset-0">
                ...
                <hr>
                <?php
                echo form_open_multipart('client/city/edit?year=' . $eventYear, array('class' => 'form-horizontal', 'id' => 'company-form'));
                ?>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                <?php
                                    ...
                                    echo form_input('field_1', set_value('field_1', $company['field_1']), 'class="form-control"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_2', htmlspecialchars_decode(set_value('field_2', $company['field_2'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_3', htmlspecialchars_decode(set_value('field_3', $company['field_3'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_4', htmlspecialchars_decode(set_value('field_4', $company['field_4'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_5', htmlspecialchars_decode(set_value('field_5', $company['field_5'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_6', htmlspecialchars_decode(set_value('field_6', $company['field_6'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_7', htmlspecialchars_decode(set_value('field_7', $company['field_7'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_8', htmlspecialchars_decode(set_value('field_8', $company['field_8'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_9', htmlspecialchars_decode(set_value('field_9', $company['field_9'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_10', htmlspecialchars_decode(set_value('field_10', $company['field_10'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_11', htmlspecialchars_decode(set_value('field_11', $company['field_11'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_12', htmlspecialchars_decode(set_value('field_12', $company['field_12'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_13', htmlspecialchars_decode(set_value('field_13', $company['field_13'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_14', htmlspecialchars_decode(set_value('field_14', $company['field_14'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_input('field_15', set_value('field_15', $company['field_15']), 'class="form-control"');
                                ?>
                            </div>
                            <div class="row">
                                <?php
                                ...
                                echo form_input('field_16', set_value('field_16', $company['field_16']), 'class="form-control"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_input('field_17', set_value('field_17', $company['field_17']), 'class="form-control"');
                                ?>
                            </div>
                            <div class="row">
                                <?php
                                ...
                                echo form_input('field_18', set_value('field_18', $company['field_18']), 'class="form-control"');
                                ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            <div class="row">
                                ...
                                echo form_textarea('field_19', htmlspecialchars_decode(set_value('field_19', $company['field_19'])), 'class="form-control tinymce-area"');
                                ?>
                            </div>
                        </div>
                    </div>
