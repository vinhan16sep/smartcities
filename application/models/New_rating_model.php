...
class New_rating_model extends CI_Model {
    ...
    public function check_rating_exist_for_list($table, $product_id, $member_id, $stype){
        $query = $this->db->select('*')
            ->from($table)
            ->where('product_id', $product_id)
            ->where('member_id', $member_id)
    ...
    public function check_rating_exist_by_product_id($stype, $table, $product_id, $user_id = null, $year = null){
        $this->db->select('*');
            $this->db->from($table);
            $this->db->where('product_id', $product_id);
